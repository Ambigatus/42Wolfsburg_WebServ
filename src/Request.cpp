...
void    Request::methodCheck(char *data, size_t size)
{
    u_int8_t character;
    ...
    for (size_t i = 0; i < size; ++i)
    {
        ...
        switch (_state)
        {
            ...
            case Request_Line_First_Space:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_First_Space)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_URI_Path_Slash:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_URI_Path_Slash)" << ENDL;
                    return ;
                }
                break ;
            }
            case Request_Line_URI_Path:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_URI_Path)" << ENDL;
                    return ;
                }
                else if ( i > MAX_URI_LENGTH)
                {
                    _error_code = 414;
                    COUT << "URI Too Long (Request_Line_URI_Path)" << ENDL;
                    return ;
                }
                break ;
            }
            case Request_Line_URI_Query:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_URI_Query)" << ENDL;
                    return ;
                }
                else if ( i > MAX_URI_LENGTH)
                {
            ...
            case Request_Line_URI_Fragment:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_URI_Fragment)" << ENDL;
                    return ;
                }
                else if ( i > MAX_URI_LENGTH)
                {
            ...
            case Request_Line_Ver:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Request URI ERROR: goes before root !!" << ENDL;
                    return ;
                }
                if (character != 'H')
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_Ver)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_HT:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_HT)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_HTT:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_HTT)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_HTTP:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_HTTP)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_HTTP_Slash:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_HTTP_Slash)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_Major:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_Major)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_Dot:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_Dot)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_Minor:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_Minor)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_CR:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_CR)" << ENDL;
                    return ;
                }
            ...
            case Request_Line_LF:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Request_Line_LF)" << ENDL;
                    return ;
                }
            ...
            case Field_Name_Start:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Field_Name_Start)" << ENDL;
                    return ;
                }
                break ;
            }
            case Fields_End:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Fields_End)" << ENDL;
                    return ;
                }
                break ;
            }
            case Field_Name:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Field_Name)" << ENDL;
                    return ;
                }
                break ;
            ...
            case Field_Value_End:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Field_Value_End)" << ENDL;
                    return ;
                }
                break ;
            }
            case Chunked_Length_Begin:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_Length_Begin)" << ENDL;
                    return ;
                }
                s.str("");
                s.clear();
            ...
            case Chunked_Length_LF:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_Length_LF)" << ENDL;
                    return ;
                }
                continue ;
            }
            ...
            case Chunked_Data_CR:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_Data_CR)" << ENDL;
                    return ;
                }
                continue ;
            }
            case Chunked_Data_LF:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_Data_LF)" << ENDL;
                    return ;
                }
                continue ;
            }
            case Chunked_End_CR:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_End_CR)" << ENDL;
                    return ;
                }
            ...
            case Chunked_End_LF:
            {
                ...
                {
                    _error_code = 400;
                    COUT << "Bad Character (Chunked_End_LF)" << ENDL;
                    return ;
                }
...
{
    COUT << _method_str[_method] + " " + _path + "?" + _query + "#" + _fragment
              + " " + "HTTP/" << _ver_major  << "." << _ver_minor << ENDL;
    ...
    COUT << "BODY FLAG =" << _body_flag << "  _BOD_done_flag= " << _body_done_flag << "FEIDLS FLAG = " << _fields_done_flag
    << ENDL;
}
